  ...
  <nav class="bg-white border-gray-200 border-b dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">C M 的博客</span>
      </a>
      <div class="flex items-center md:order-2">
        ...
        <!-- 登录 -->
        <div class="text-gray-900 ml-1 mr-1 hover:text-blue-700 dark:text-white cursor-pointer" @click="$router.push('/login')">登录</div>
